...
public class CalendarQuickstart {
  ...
  //         Calendar calendarService = new Calendar.Builder(HTTP_TRANSPORT,
  //         JSON_FACTORY, getCredentials(HTTP_TRANSPORT))
  //                 .setApplicationName("applicationName").build();
  //
  //         // Iterate through entries in calendar list and store them in
  //         hash map String pageToken = null; do {
  //             CalendarList calendarList =
  //             calendarService.calendarList().list().setPageToken(pageToken).execute();
  ...
  //
  //         // iterate through hash table and fetch first ten events for each
  //         calendar ID for (String calendarID : calendarsListHT.keySet()) {
  //             DateTime now = new DateTime(System.currentTimeMillis());
