...
public class Endpoints {
    ...
    public static void addNewUser(
        ...
        DatabaseManager.currentUser user = new DatabaseManager.currentUser(email, timezone, calendar_id, preferred_start,
    ...
    public static DatabaseManager.currentUser currentUser(@RequestParam(value = "email") String email) {
        ...
        Document pt = (Document) d.get("preferred_timerange");
        Document st = (Document) d.get("suboptimal_timerange");
        DatabaseManager.currentUser user = new DatabaseManager.currentUser(email, d.getString("timezone"),
                (List<String>) d.get("calendar_id"), (List<Double>) pt.get("start"), (List<Double>) pt.get("end"),
                (List<List<Boolean>>) pt.get("days"), (List<Double>) st.get("suboptimal_start"),
                (List<Double>) st.get("suboptimal_end"), (List<List<Boolean>>) st.get("suboptimal_days"));
