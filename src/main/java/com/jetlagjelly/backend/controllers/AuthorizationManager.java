...
public class AuthorizationManager {
  private static final String CLIENT_ID = System.getenv(
      "CLIENT_ID"); //"1018210986187-ve886ig30rfadhe5ahrmu2tg391ohq8s.apps.googleusercontent.com";
  private static final String CLIENT_SECRET =
      System.getenv("CLIENT_SECRET"); //"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";
  private static final String REDIRECT_URI =
      System.getenv("REDIRECT_URI"); //"http://localhost:7000/oauth2callback";
  ...
  public static String exchangeCode(String code)
    ...
    GoogleAuthorizationCodeFlow flow =
        new GoogleAuthorizationCodeFlow
            .Builder(httpTransport, jsonFactory, CLIENT_ID, CLIENT_SECRET,
    ...
    try {
      ...
      System.err.println("Error exchanging authorization code: " +
                         e.getMessage());
      return null;
    }
